...
//
// Ground truth for normalization: check-refs.py's `normalize` (check-refs.py:38-45), cited via
...
/** Port of check-refs.py's `normalize` (check-refs.py:38-45). LaTeX command names and `$` are
 ...
 * null when the pattern is not present at all. */
