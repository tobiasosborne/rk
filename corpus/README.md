...
15 report-shards + 11 freshness + 21 reward = **161 fixtures** (reconciled 2026-08-10,
rk-sp3n closed; the wave-1 panel's reviewer C recomputed the true counts) across the gates named in
