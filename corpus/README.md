...
| `reward-10` | reward | green twin: proved-mod-audit close backed by a different recorded verifier identity ⇒ pass | **rk-ne3a no-false-positive guard**: identities are driver-supplied provenance, not authenticated identities. | landed |
