...
Totals: 5 config + 15 defs + 46 argument/linker + 16 refs + 24 provenance + 8 runs +
15 report-shards + 11 freshness + 25 reward = **165 fixtures** (reconciled 2026-08-10,
rk-sp3n closed; the wave-1 panel's reviewer C recomputed the true counts; +2 rk-io5l and
+2 rk-tlwb, 2026-08-12) across the gates named in
