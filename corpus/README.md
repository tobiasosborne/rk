...
Totals: 7 config + 20 defs + 4 notation + 46 argument/linker + 22 refs + 24 provenance + 10 runs +
15 report-shards + 12 freshness + 28 reward = **188 fixtures** (reconciled 2026-08-10,
...
`config-06`, `config-07`, `freshness-12`, `notation-01`..`notation-04` 2026-08-20) across the gates named in
