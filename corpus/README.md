...
Totals: 15 defs + 27 argument/linker + 8 refs + 19 provenance + 8 runs + 15 report-shards = **92
...
all 92 fixtures, and not by itself a reason to assert on it). By that criterion:
...
Every other fixture (the remaining 81 = 92 total − 11 with an asserted `coverage` expectation) is a
