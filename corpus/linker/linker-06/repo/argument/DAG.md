...
# Argument DAG (2 results, 2 edges)
...
graph LR
  ...
  lem-cycle-a["lem-cycle-a<br/>stated/none"]
  lem-cycle-b["lem-cycle-b<br/>stated/none"]
  lem-cycle-a --> lem-cycle-b
  lem-cycle-b --> lem-cycle-a
  class lem-cycle-a,lem-cycle-b stated;
```
