...
- `bundles/rk-campaign-A.bundle`, `bundles/rk-campaign-C.bundle` — full-history
  `git bundle --all` snapshots of the two campaign repositories (both have no
  remote). History matters: e.g. the campaign-A backing waiver reasons from
